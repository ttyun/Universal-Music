...
//
//  Created by Tyler Yun on 3/21/17.
//  Copyright © 2017 Tyler Yun. All rights reserved.
//

import UIKit

class AppleMusicData: NSObject, NSCoding {
    static let DocumentsDirectory = FileManager().urls(for: .documentDirectory, in: .userDomainMask).first
    
    static let ArchiveURL = DocumentsDirectory?.appendingPathComponent("savedAppleMusicData")
